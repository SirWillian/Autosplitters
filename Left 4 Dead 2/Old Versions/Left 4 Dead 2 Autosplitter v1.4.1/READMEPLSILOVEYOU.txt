...
If you don't want to use that option and set this up manually, do the following:
...
It's also important to note that the splitter has about a frame of delay, but it starts a
frame late and ends a frame late, so the time should be correct overall. The run should be 
retimed manually if the time is to close to the end/beginning of a second and it could be a 
tie-breaker.
