...
state("left4dead2", "Newest")
{
	...
	bool     hasControl       : "client.dll", 0x72767C;
}
...
startup
{
	...
	settings.Add("version2075", false, "Version 2.0.7.5", "version2027");
	settings.Add("version2091", false, "Version 2.0.9.1", "version2075");
	settings.Add("version2147", false, "Newest Version", "version2091");
